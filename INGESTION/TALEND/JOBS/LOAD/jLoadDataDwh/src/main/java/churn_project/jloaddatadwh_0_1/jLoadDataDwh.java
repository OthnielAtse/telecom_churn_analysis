...
package churn_project.jloaddatadwh_0_1;
...
/**
 * Job: jLoadDataDwh Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class jLoadDataDwh implements TalendJob {
...
public String getProjectFolder(){
	...
	private final String jobName = "jLoadDataDwh";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jLoadDataDwh.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
context.projectFolder = "D:/Universite de Tours -Antenne de Blois/Data Analyst Learning/Power Bi Projects/Projects/BI Churn Project/Talend Project/";
 ...
 */
	...
	System.err.println("Le repertoire " + context.projectFolder + context.dataFolder + TalendDate.getDate("YYYYMMDD") + "/"  +"  ne contient aucun fichier plats pour le charement dans le data warehouse" );
	
	globalMap.put("tDie_1_DIE_MESSAGE", "Le repertoire " + context.projectFolder + context.dataFolder + TalendDate.getDate("YYYYMMDD") + "/"  +"  ne contient aucun fichier plats pour le charement dans le data warehouse" );
	globalMap.put("tDie_1_DIE_MESSAGES", "Le repertoire " + context.projectFolder + context.dataFolder + TalendDate.getDate("YYYYMMDD") + "/"  +"  ne contient aucun fichier plats pour le charement dans le data warehouse" );
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_CHURN_PROJECT_jLoadDataDwh = new byte[0];
    static byte[] commonByteArray_CHURN_PROJECT_jLoadDataDwh = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_CHURN_PROJECT_jLoadDataDwh.length) {
				if(length < 1024 && commonByteArray_CHURN_PROJECT_jLoadDataDwh.length == 0) {
   					commonByteArray_CHURN_PROJECT_jLoadDataDwh = new byte[1024];
				} else {
   					commonByteArray_CHURN_PROJECT_jLoadDataDwh = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_CHURN_PROJECT_jLoadDataDwh, 0, length);
			strReturn = new String(commonByteArray_CHURN_PROJECT_jLoadDataDwh, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_CHURN_PROJECT_jLoadDataDwh, 0, length);
			strReturn = new String(commonByteArray_CHURN_PROJECT_jLoadDataDwh, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_CHURN_PROJECT_jLoadDataDwh) {
...
StringBuilder result_tFixedFlowInput_1 = new StringBuilder();
	result_tFixedFlowInput_1.append("akxvYWRMb2NhdGlvbkRpbQ0KakxvYWRDaHVybkRpbQ0KakxvYWRDb250cmFjdERpbQ0KakxvYWRD");
	result_tFixedFlowInput_1.append("dXN0b21lckRpbQ0KakxvYWRPZmZlckRpbQ0KakxvYWRQYXltZW50TW9kZURpbQ0KakxvYWRTZXJ2");
	result_tFixedFlowInput_1.append("aWNlc0RpbQ0KakxvYWRGYWN0VGFibGVEaW0=");
	...
	String audit_jar_path_tRunJob_1 = System.getProperty("classpath.extended");
		...
		if (classpathSeparator_tRunJob_1 != null && classpathSeparator_tRunJob_1.length() > 1) {
			throw new RuntimeException("path separator should be single character");
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
					...
					System.getProperties().stringPropertyNames().stream()
						...
						.forEach(key -> cc_tRunJob_1_0.add("-D" + key + "=" + System.getProperty(key)));
				    		...
				    		jvm_argument_helper_tRunJob_1.addArgumentsTo(childJob_commandLine_tRunJob_1, "churn_project.jloadchurndim_0_1.jLoadChurnDim".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jLoadChurnDim",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
					...
					System.getProperties().stringPropertyNames().stream()
						...
						.forEach(key -> cc_tRunJob_1_1.add("-D" + key + "=" + System.getProperty(key)));
				    		...
				    		jvm_argument_helper_tRunJob_1.addArgumentsTo(childJob_commandLine_tRunJob_1, "churn_project.jloadcontractdim_0_1.jLoadContractDim".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jLoadContractDim",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
					...
					System.getProperties().stringPropertyNames().stream()
						...
						.forEach(key -> cc_tRunJob_1_2.add("-D" + key + "=" + System.getProperty(key)));
				    		...
				    		String classpath_tRunJob_1_2_5 = ".;../lib/routines.jar;../lib/log4j-slf4j-impl-2.13.2.jar;../lib/log4j-api-2.13.2.jar;../lib/log4j-core-2.13.2.jar;../lib/log4j-1.2-api-2.13.2.jar;../lib/commons-collections-3.2.2.jar;../lib/jboss-marshalling-river-2.0.12.Final.jar;../lib/jboss-marshalling-2.0.12.Final.jar;../lib/talend_file_enhanced-1.1.jar;../lib/advancedPersistentLookupLib-1.3.jar;../lib/dom4j-2.1.3.jar;../lib/slf4j-api-1.7.29.jar;../lib/trove.jar;../lib/postgresql-42.2.14.jar;../lib/talendcsv-1.0.0.jar;../lib/crypto-utils-0.31.12.jar;jloadcustomerdim_0_1.jar;";
				    		...
				    		jvm_argument_helper_tRunJob_1.addArgumentsTo(childJob_commandLine_tRunJob_1, "churn_project.jloadcustomerdim_0_1.jLoadCustomerDim".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jLoadCustomerDim",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
					...
					System.getProperties().stringPropertyNames().stream()
						...
						.forEach(key -> cc_tRunJob_1_3.add("-D" + key + "=" + System.getProperty(key)));
				    		...
				    		jvm_argument_helper_tRunJob_1.addArgumentsTo(childJob_commandLine_tRunJob_1, "churn_project.jloadfacttabledim_0_1.jLoadFactTableDim".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jLoadFactTableDim",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
					...
					System.getProperties().stringPropertyNames().stream()
						...
						.forEach(key -> cc_tRunJob_1_4.add("-D" + key + "=" + System.getProperty(key)));
				    		...
				    		String classpath_tRunJob_1_4_5 = ".;../lib/routines.jar;../lib/log4j-slf4j-impl-2.13.2.jar;../lib/log4j-api-2.13.2.jar;../lib/log4j-core-2.13.2.jar;../lib/log4j-1.2-api-2.13.2.jar;../lib/commons-collections-3.2.2.jar;../lib/jboss-marshalling-river-2.0.12.Final.jar;../lib/jboss-marshalling-2.0.12.Final.jar;../lib/talend_file_enhanced-1.1.jar;../lib/advancedPersistentLookupLib-1.3.jar;../lib/dom4j-2.1.3.jar;../lib/slf4j-api-1.7.29.jar;../lib/trove.jar;../lib/postgresql-42.2.14.jar;../lib/talendcsv-1.0.0.jar;../lib/crypto-utils-0.31.12.jar;jloadlocationdim_0_1.jar;";
				    		...
				    		jvm_argument_helper_tRunJob_1.addArgumentsTo(childJob_commandLine_tRunJob_1, "churn_project.jloadlocationdim_0_1.jLoadLocationDim".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jLoadLocationDim",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
					...
					System.getProperties().stringPropertyNames().stream()
						...
						.forEach(key -> cc_tRunJob_1_5.add("-D" + key + "=" + System.getProperty(key)));
				    		...
				    		String classpath_tRunJob_1_5_5 = ".;../lib/routines.jar;../lib/log4j-slf4j-impl-2.13.2.jar;../lib/log4j-api-2.13.2.jar;../lib/log4j-core-2.13.2.jar;../lib/log4j-1.2-api-2.13.2.jar;../lib/commons-collections-3.2.2.jar;../lib/jboss-marshalling-river-2.0.12.Final.jar;../lib/jboss-marshalling-2.0.12.Final.jar;../lib/talend_file_enhanced-1.1.jar;../lib/advancedPersistentLookupLib-1.3.jar;../lib/dom4j-2.1.3.jar;../lib/slf4j-api-1.7.29.jar;../lib/trove.jar;../lib/postgresql-42.2.14.jar;../lib/talendcsv-1.0.0.jar;../lib/crypto-utils-0.31.12.jar;jloadofferdim_0_1.jar;";
				    		...
				    		jvm_argument_helper_tRunJob_1.addArgumentsTo(childJob_commandLine_tRunJob_1, "churn_project.jloadofferdim_0_1.jLoadOfferDim".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jLoadOfferDim",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
					...
					System.getProperties().stringPropertyNames().stream()
						...
						.forEach(key -> cc_tRunJob_1_6.add("-D" + key + "=" + System.getProperty(key)));
				    		...
				    		String classpath_tRunJob_1_6_5 = ".;../lib/routines.jar;../lib/log4j-slf4j-impl-2.13.2.jar;../lib/log4j-api-2.13.2.jar;../lib/log4j-core-2.13.2.jar;../lib/log4j-1.2-api-2.13.2.jar;../lib/commons-collections-3.2.2.jar;../lib/jboss-marshalling-river-2.0.12.Final.jar;../lib/jboss-marshalling-2.0.12.Final.jar;../lib/talend_file_enhanced-1.1.jar;../lib/advancedPersistentLookupLib-1.3.jar;../lib/dom4j-2.1.3.jar;../lib/slf4j-api-1.7.29.jar;../lib/trove.jar;../lib/postgresql-42.2.14.jar;../lib/talendcsv-1.0.0.jar;../lib/crypto-utils-0.31.12.jar;jloadservicesdim_0_1.jar;";
				    		...
				    		jvm_argument_helper_tRunJob_1.addArgumentsTo(childJob_commandLine_tRunJob_1, "churn_project.jloadservicesdim_0_1.jLoadServicesDim".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jLoadServicesDim",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
					...
					System.getProperties().stringPropertyNames().stream()
						...
						.forEach(key -> cc_tRunJob_1_7.add("-D" + key + "=" + System.getProperty(key)));
				    		...
				    		String classpath_tRunJob_1_7_5 = ".;../lib/routines.jar;../lib/log4j-slf4j-impl-2.13.2.jar;../lib/log4j-api-2.13.2.jar;../lib/log4j-core-2.13.2.jar;../lib/log4j-1.2-api-2.13.2.jar;../lib/commons-collections-3.2.2.jar;../lib/jboss-marshalling-river-2.0.12.Final.jar;../lib/jboss-marshalling-2.0.12.Final.jar;../lib/talend_file_enhanced-1.1.jar;../lib/advancedPersistentLookupLib-1.3.jar;../lib/dom4j-2.1.3.jar;../lib/slf4j-api-1.7.29.jar;../lib/trove.jar;../lib/postgresql-42.2.14.jar;../lib/talendcsv-1.0.0.jar;../lib/crypto-utils-0.31.12.jar;jloadpaymentmodedim_0_1.jar;";
				    		...
				    		jvm_argument_helper_tRunJob_1.addArgumentsTo(childJob_commandLine_tRunJob_1, "churn_project.jloadpaymentmodedim_0_1.jLoadPaymentModeDim".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jLoadPaymentModeDim",childJob_commandLine_tRunJob_1);	
 ...
 */
    ...
    public static void main(String[] args){
        final jLoadDataDwh jLoadDataDwhClass = new jLoadDataDwh();

        int exitCode = jLoadDataDwhClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jLoadDataDwh.class.getClassLoader().getResourceAsStream("churn_project/jloaddatadwh_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = jLoadDataDwh.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jLoadDataDwh");
        }
...
/************************************************************************************************
 *     124494 characters generated by Talend Open Studio for Data Integration 
