...
package churn_project.jloadservicesdim_0_1;
...
/**
 * Job: jLoadServicesDim Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class jLoadServicesDim implements TalendJob {
...
public String getProjectFolder(){
	...
	private final String jobName = "jLoadServicesDim";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jLoadServicesDim.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jLoadServicesDim.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
globalMap.put("nomFichier", "CHURN_"+ TalendDate.getDate("YYYYMMDD") +"_SERVICE.csv");
globalMap.put("nomFlux", "SERVICE");
...
public static class insertServicesStruct implements routines.system.IPersistableRow<insertServicesStruct> {
    final static byte[] commonByteArrayLock_CHURN_PROJECT_jLoadServicesDim = new byte[0];
    static byte[] commonByteArray_CHURN_PROJECT_jLoadServicesDim = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final insertServicesStruct other = (insertServicesStruct) obj;
	...
	public void copyDataTo(insertServicesStruct other) {
	...
	public void copyKeysDataTo(insertServicesStruct other) {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_CHURN_PROJECT_jLoadServicesDim.length) {
				if(length < 1024 && commonByteArray_CHURN_PROJECT_jLoadServicesDim.length == 0) {
   					commonByteArray_CHURN_PROJECT_jLoadServicesDim = new byte[1024];
				} else {
   					commonByteArray_CHURN_PROJECT_jLoadServicesDim = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_CHURN_PROJECT_jLoadServicesDim, 0, length);
			strReturn = new String(commonByteArray_CHURN_PROJECT_jLoadServicesDim, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_CHURN_PROJECT_jLoadServicesDim, 0, length);
			strReturn = new String(commonByteArray_CHURN_PROJECT_jLoadServicesDim, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_CHURN_PROJECT_jLoadServicesDim) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.PHONE_SERVICE = readString(dis);
					
					this.MULTIPLE_LINES = readString(dis);
					
					this.INTERNET_SERVICE = readString(dis);
					
					this.INTERNET_TYPE = readString(dis);
					
					this.ONLINE_SECURITY = readString(dis);
					
					this.ONLINE_BACKUP = readString(dis);
					
					this.DEVICE_PROTECTION = readString(dis);
					
					this.PREMIUM_TECH_SUPPORT = readString(dis);
					
					this.STREAMING_TV = readString(dis);
					
					this.STREAMING_MOVIES = readString(dis);
					
					this.STREAMING_MUSIC = readString(dis);
					
					this.UNLIMITED_DATA = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.PHONE_SERVICE,dos);
					
					// String
				
						writeString(this.MULTIPLE_LINES,dos);
					
					// String
				
						writeString(this.INTERNET_SERVICE,dos);
					
					// String
				
						writeString(this.INTERNET_TYPE,dos);
					
					// String
				
						writeString(this.ONLINE_SECURITY,dos);
					
					// String
				
						writeString(this.ONLINE_BACKUP,dos);
					
					// String
				
						writeString(this.DEVICE_PROTECTION,dos);
					
					// String
				
						writeString(this.PREMIUM_TECH_SUPPORT,dos);
					
					// String
				
						writeString(this.STREAMING_TV,dos);
					
					// String
				
						writeString(this.STREAMING_MOVIES,dos);
					
					// String
				
						writeString(this.STREAMING_MUSIC,dos);
					
					// String
				
						writeString(this.UNLIMITED_DATA,dos);
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("DWH_DIM_SERVICE");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("DWH_DIM_SERVICE");
}
...
int count_tDBOutput_1=0;
	    java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_1 + "\" WHERE \"SERVICE_ID\" = ?");
	    resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"SERVICE_ID\",\"PHONE_SERVICE\",\"MULTIPLE_LINES\",\"INTERNET_SERVICE\",\"INTERNET_TYPE\",\"ONLINE_SECURITY\",\"ONLINE_BACKUP\",\"DEVICE_PROTECTION\",\"PREMIUM_TECH_SUPPORT\",\"STREAMING_TV\",\"STREAMING_MOVIES\",\"STREAMING_MUSIC\",\"UNLIMITED_DATA\",\"LB_NOM_FICHIER\",\"DT_INSERTION\",\"LB_JOB_NAME\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
	    java.sql.PreparedStatement pstmtInsert_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(insert_tDBOutput_1);
	    resourceMap.put("pstmtInsert_tDBOutput_1", pstmtInsert_tDBOutput_1);
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"PHONE_SERVICE\" = ?,\"MULTIPLE_LINES\" = ?,\"INTERNET_SERVICE\" = ?,\"INTERNET_TYPE\" = ?,\"ONLINE_SECURITY\" = ?,\"ONLINE_BACKUP\" = ?,\"DEVICE_PROTECTION\" = ?,\"PREMIUM_TECH_SUPPORT\" = ?,\"STREAMING_TV\" = ?,\"STREAMING_MOVIES\" = ?,\"STREAMING_MUSIC\" = ?,\"UNLIMITED_DATA\" = ?,\"LB_NOM_FICHIER\" = ?,\"DT_INSERTION\" = ?,\"LB_JOB_NAME\" = ? WHERE \"SERVICE_ID\" = ?";
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
					...
					columnIndexWithD_tFileInputDelimited_1 = 1;
							...
							row1.ServiceHash = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
					...
					columnIndexWithD_tFileInputDelimited_1 = 4;
							...
							row1.InternetService = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 5;
					
							row1.InternetType = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
					...
					columnIndexWithD_tFileInputDelimited_1 = 8;
							...
							row1.DeviceProtectionPlan = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 9;
					
							row1.PremiumTechSupport = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
					...
					columnIndexWithD_tFileInputDelimited_1 = 11;
							...
							row1.StreamingMovies = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 12;
					
							row1.StreamingMusic = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 13;
					
							row1.UnlimitedData = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
								  ...
								  if(hasCasePrimitiveKeyWithNull_tMap_1 || !tHash_Lookup_row2.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.SERVICE_ID = '" + row2HashKey.SERVICE_ID + "'");
								} // G 071
...
insertServices_tmp.PHONE_SERVICE = row1.PhoneService ;
insertServices_tmp.MULTIPLE_LINES = row1.MultipleLines ;
insertServices_tmp.INTERNET_SERVICE = row1.InternetService ;
insertServices_tmp.INTERNET_TYPE = row1.InternetType ;
insertServices_tmp.ONLINE_SECURITY = row1.OnlineSecurity ;
insertServices_tmp.ONLINE_BACKUP = row1.OnlineBackup ;
insertServices_tmp.DEVICE_PROTECTION = row1.DeviceProtectionPlan ;
insertServices_tmp.PREMIUM_TECH_SUPPORT = row1.PremiumTechSupport ;
insertServices_tmp.STREAMING_TV = row1.StreamingTV ;
insertServices_tmp.STREAMING_MOVIES = row1.StreamingMovies ;
insertServices_tmp.STREAMING_MUSIC = row1.StreamingMusic ;
insertServices_tmp.UNLIMITED_DATA = row1.UnlimitedData ;
...
if(insertServices != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    pstmt_tDBOutput_1.setInt(1, insertServices.SERVICE_ID);
            ...
            if(checkCount_tDBOutput_1 > 0) {
                        if(insertServices.PHONE_SERVICE == null) {
pstmtUpdate_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(1, insertServices.PHONE_SERVICE);
}

                        if(insertServices.MULTIPLE_LINES == null) {
pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(2, insertServices.MULTIPLE_LINES);
}

                        if(insertServices.INTERNET_SERVICE == null) {
pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(3, insertServices.INTERNET_SERVICE);
}

                        if(insertServices.INTERNET_TYPE == null) {
pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(4, insertServices.INTERNET_TYPE);
}

                        if(insertServices.ONLINE_SECURITY == null) {
pstmtUpdate_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(5, insertServices.ONLINE_SECURITY);
}

                        if(insertServices.ONLINE_BACKUP == null) {
pstmtUpdate_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(6, insertServices.ONLINE_BACKUP);
}

                        if(insertServices.DEVICE_PROTECTION == null) {
pstmtUpdate_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(7, insertServices.DEVICE_PROTECTION);
}

                        if(insertServices.PREMIUM_TECH_SUPPORT == null) {
pstmtUpdate_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(8, insertServices.PREMIUM_TECH_SUPPORT);
}

                        if(insertServices.STREAMING_TV == null) {
pstmtUpdate_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(9, insertServices.STREAMING_TV);
}

                        if(insertServices.STREAMING_MOVIES == null) {
pstmtUpdate_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(10, insertServices.STREAMING_MOVIES);
}

                        if(insertServices.STREAMING_MUSIC == null) {
pstmtUpdate_tDBOutput_1.setNull(11, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(11, insertServices.STREAMING_MUSIC);
}

                        if(insertServices.UNLIMITED_DATA == null) {
pstmtUpdate_tDBOutput_1.setNull(12, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(12, insertServices.UNLIMITED_DATA);
}

                        if(insertServices.LB_NOM_FICHIER == null) {
pstmtUpdate_tDBOutput_1.setNull(13, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(13, insertServices.LB_NOM_FICHIER);
}

                        if(insertServices.DT_INSERTION != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(14, new java.sql.Timestamp(insertServices.DT_INSERTION.getTime()));
} else {
pstmtUpdate_tDBOutput_1.setNull(14, java.sql.Types.TIMESTAMP);
}

                        if(insertServices.LB_JOB_NAME == null) {
pstmtUpdate_tDBOutput_1.setNull(15, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(15, insertServices.LB_JOB_NAME);
}

                        pstmtUpdate_tDBOutput_1.setInt(16 + count_tDBOutput_1, insertServices.SERVICE_ID);
...
globalMap.put("tDBOutput_1_ERROR_MESSAGE",e.getMessage());
                    ...
                    whetherReject_tDBOutput_1 = true;
                        ...
                        pstmtInsert_tDBOutput_1.setInt(1, insertServices.SERVICE_ID);

                        if(insertServices.PHONE_SERVICE == null) {
pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(2, insertServices.PHONE_SERVICE);
}

                        if(insertServices.MULTIPLE_LINES == null) {
pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(3, insertServices.MULTIPLE_LINES);
}

                        if(insertServices.INTERNET_SERVICE == null) {
pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(4, insertServices.INTERNET_SERVICE);
}

                        if(insertServices.INTERNET_TYPE == null) {
pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(5, insertServices.INTERNET_TYPE);
}

                        if(insertServices.ONLINE_SECURITY == null) {
pstmtInsert_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(6, insertServices.ONLINE_SECURITY);
}

                        if(insertServices.ONLINE_BACKUP == null) {
pstmtInsert_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(7, insertServices.ONLINE_BACKUP);
}

                        if(insertServices.DEVICE_PROTECTION == null) {
pstmtInsert_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(8, insertServices.DEVICE_PROTECTION);
}

                        if(insertServices.PREMIUM_TECH_SUPPORT == null) {
pstmtInsert_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(9, insertServices.PREMIUM_TECH_SUPPORT);
}

                        if(insertServices.STREAMING_TV == null) {
pstmtInsert_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(10, insertServices.STREAMING_TV);
}

                        if(insertServices.STREAMING_MOVIES == null) {
pstmtInsert_tDBOutput_1.setNull(11, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(11, insertServices.STREAMING_MOVIES);
}

                        if(insertServices.STREAMING_MUSIC == null) {
pstmtInsert_tDBOutput_1.setNull(12, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(12, insertServices.STREAMING_MUSIC);
}

                        if(insertServices.UNLIMITED_DATA == null) {
pstmtInsert_tDBOutput_1.setNull(13, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(13, insertServices.UNLIMITED_DATA);
}

                        if(insertServices.LB_NOM_FICHIER == null) {
pstmtInsert_tDBOutput_1.setNull(14, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(14, insertServices.LB_NOM_FICHIER);
}

                        if(insertServices.DT_INSERTION != null) {
pstmtInsert_tDBOutput_1.setTimestamp(15, new java.sql.Timestamp(insertServices.DT_INSERTION.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_1.setString(16, insertServices.LB_JOB_NAME);
}
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.password; 
            ...
            row2.SERVICE_ID = rs_tDBInput_1.getInt(1);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row2.PHONE_SERVICE = null;
							} else {
	                         		
        	row2.PHONE_SERVICE = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row2.MULTIPLE_LINES = null;
							} else {
	                         		
        	row2.MULTIPLE_LINES = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row2.INTERNET_SERVICE = null;
							} else {
	                         		
        	row2.INTERNET_SERVICE = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row2.INTERNET_TYPE = null;
							} else {
	                         		
        	row2.INTERNET_TYPE = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								row2.ONLINE_SECURITY = null;
							} else {
	                         		
        	row2.ONLINE_SECURITY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 6, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 7) {
								row2.ONLINE_BACKUP = null;
							} else {
	                         		
        	row2.ONLINE_BACKUP = routines.system.JDBCUtil.getString(rs_tDBInput_1, 7, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 8) {
								row2.DEVICE_PROTECTION = null;
							} else {
	                         		
        	row2.DEVICE_PROTECTION = routines.system.JDBCUtil.getString(rs_tDBInput_1, 8, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 9) {
								row2.PREMIUM_TECH_SUPPORT = null;
							} else {
	                         		
        	row2.PREMIUM_TECH_SUPPORT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 9, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 10) {
								row2.STREAMING_TV = null;
							} else {
	                         		
        	row2.STREAMING_TV = routines.system.JDBCUtil.getString(rs_tDBInput_1, 10, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 11) {
								row2.STREAMING_MOVIES = null;
							} else {
	                         		
        	row2.STREAMING_MOVIES = routines.system.JDBCUtil.getString(rs_tDBInput_1, 11, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 12) {
								row2.STREAMING_MUSIC = null;
							} else {
	                         		
        	row2.STREAMING_MUSIC = routines.system.JDBCUtil.getString(rs_tDBInput_1, 12, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 13) {
								row2.UNLIMITED_DATA = null;
							} else {
	                         		
        	row2.UNLIMITED_DATA = routines.system.JDBCUtil.getString(rs_tDBInput_1, 13, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 14) {
								row2.LB_NOM_FICHIER = null;
							} else {
	                         		
        	row2.LB_NOM_FICHIER = routines.system.JDBCUtil.getString(rs_tDBInput_1, 14, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 15) {
								row2.DT_INSERTION = null;
							} else {
										
			row2.DT_INSERTION = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 15);
		                    }
							if(colQtyInRs_tDBInput_1 < 16) {
								row2.LB_JOB_NAME = null;
							} else {
	                         		
        	row2.LB_JOB_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_1, 16, false);
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row2";
				...
				row2_HashRow.PHONE_SERVICE = row2.PHONE_SERVICE;
				
				row2_HashRow.MULTIPLE_LINES = row2.MULTIPLE_LINES;
				
				row2_HashRow.INTERNET_SERVICE = row2.INTERNET_SERVICE;
				
				row2_HashRow.INTERNET_TYPE = row2.INTERNET_TYPE;
				
				row2_HashRow.ONLINE_SECURITY = row2.ONLINE_SECURITY;
				
				row2_HashRow.ONLINE_BACKUP = row2.ONLINE_BACKUP;
				
				row2_HashRow.DEVICE_PROTECTION = row2.DEVICE_PROTECTION;
				
				row2_HashRow.PREMIUM_TECH_SUPPORT = row2.PREMIUM_TECH_SUPPORT;
				
				row2_HashRow.STREAMING_TV = row2.STREAMING_TV;
				
				row2_HashRow.STREAMING_MOVIES = row2.STREAMING_MOVIES;
				
				row2_HashRow.STREAMING_MUSIC = row2.STREAMING_MUSIC;
				
				row2_HashRow.UNLIMITED_DATA = row2.UNLIMITED_DATA;
 ...
 */
    ...
    public static void main(String[] args){
        final jLoadServicesDim jLoadServicesDimClass = new jLoadServicesDim();

        int exitCode = jLoadServicesDimClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jLoadServicesDim.class.getClassLoader().getResourceAsStream("churn_project/jloadservicesdim_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = jLoadServicesDim.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jLoadServicesDim");
        }
...
/************************************************************************************************
 *     177924 characters generated by Talend Open Studio for Data Integration 
 *     on the 30 décembre 2025 à 22:42:00 EET
 ************************************************************************************************/