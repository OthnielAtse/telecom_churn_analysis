...
package churn_project.jextractservices_0_1;
...
/**
 * Job: jExtractServices Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class jExtractServices implements TalendJob {
...
public String getProjectFolder(){
	...
	private final String jobName = "jExtractServices";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jExtractServices.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jExtractServices.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
java.io.File file_tFileExist_1 = new java.io.File(context.dataFolder + TalendDate.getDate("YYYYMMDD") + "/" + "CHURN_"+ TalendDate.getDate("YYYYMMDD") +"_SERVICE.csv");
...
globalMap.put("tFileExist_1_FILENAME",context.dataFolder + TalendDate.getDate("YYYYMMDD") + "/" + "CHURN_"+ TalendDate.getDate("YYYYMMDD") +"_SERVICE.csv");
...
public static class uniqueServicesStruct implements routines.system.IPersistableRow<uniqueServicesStruct> {
    final static byte[] commonByteArrayLock_CHURN_PROJECT_jExtractServices = new byte[0];
    static byte[] commonByteArray_CHURN_PROJECT_jExtractServices = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_CHURN_PROJECT_jExtractServices.length) {
				if(length < 1024 && commonByteArray_CHURN_PROJECT_jExtractServices.length == 0) {
   					commonByteArray_CHURN_PROJECT_jExtractServices = new byte[1024];
				} else {
   					commonByteArray_CHURN_PROJECT_jExtractServices = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_CHURN_PROJECT_jExtractServices, 0, length);
			strReturn = new String(commonByteArray_CHURN_PROJECT_jExtractServices, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_CHURN_PROJECT_jExtractServices, 0, length);
			strReturn = new String(commonByteArray_CHURN_PROJECT_jExtractServices, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_CHURN_PROJECT_jExtractServices) {
     ...
     * Compare keys
     */
    public int compareTo(uniqueServicesStruct other) {
...
uniqueServicesStruct uniqueServices = new uniqueServicesStruct();
	...
	currentComponent="tFileOutputDelimited_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"uniqueServices");
					}
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File(context.dataFolder + TalendDate.getDate("YYYYMMDD") + "/" + "CHURN_"+ TalendDate.getDate("YYYYMMDD") +"_SERVICE.csv")).getAbsolutePath().replace("\\","/");
                    ...
                    if(directory_tFileOutputDelimited_1 != null && directory_tFileOutputDelimited_1.trim().length() != 0) {
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_1, false),"ISO-8859-15"));
                                    if(filetFileOutputDelimited_1.length()==0){
                                        ...
                                        outtFileOutputDelimited_1.write("ServiceHash");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
...
uniqueServicesStruct uniqueServices_tmp = new uniqueServicesStruct();
// ###############################
...
Var.servicehash = ServiceHash.buildServiceHash(
    row1.PhoneService,
    row1.MultipleLines,
...
customers_tmp.ServiceID = null;
customers_tmp.ServiceHash = Var.servicehash ;
customers_tmp.PhoneService = row1.PhoneService ;
customers_tmp.MultipleLines = row1.MultipleLines ;
customers_tmp.InternetService = row1.InternetService ;
customers_tmp.InternetType = row1.InternetType ;
customers_tmp.OnlineSecurity = row1.OnlineSecurity ;
customers_tmp.OnlineBackup = row1.OnlineBackup ;
customers_tmp.DeviceProtectionPlan = row1.DeviceProtectionPlan ;
customers_tmp.PremiumTechSupport = row1.PremiumTechSupport ;
customers_tmp.StreamingTV = row1.StreamingTV ;
customers_tmp.StreamingMovies = row1.StreamingMovies ;
customers_tmp.StreamingMusic = row1.StreamingMusic ;
customers_tmp.UnlimitedData = row1.UnlimitedData ;
...
row2 = null;			
if(customers.ServiceHash == null){
	finder_tUniqRow_1.ServiceHash = null;
}else{
	finder_tUniqRow_1.ServiceHash = customers.ServiceHash.toLowerCase();
}	
...
if(customers.ServiceHash == null){
	new_tUniqRow_1.ServiceHash = null;
}else{
	new_tUniqRow_1.ServiceHash = customers.ServiceHash.toLowerCase();
}
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row2 == null){ 
	
	row2 = new row2Struct();
}row2.ServiceID = customers.ServiceID;			row2.ServiceHash = customers.ServiceHash;			row2.PhoneService = customers.PhoneService;			row2.MultipleLines = customers.MultipleLines;			row2.InternetService = customers.InternetService;			row2.InternetType = customers.InternetType;			row2.OnlineSecurity = customers.OnlineSecurity;			row2.OnlineBackup = customers.OnlineBackup;			row2.DeviceProtectionPlan = customers.DeviceProtectionPlan;			row2.PremiumTechSupport = customers.PremiumTechSupport;			row2.StreamingTV = customers.StreamingTV;			row2.StreamingMovies = customers.StreamingMovies;			row2.StreamingMusic = customers.StreamingMusic;			row2.UnlimitedData = customers.UnlimitedData;					
...
// # Output table : 'uniqueServices'
uniqueServices_tmp.ServiceID = Var.id ;
uniqueServices_tmp.ServiceHash = row2.ServiceHash ;
uniqueServices_tmp.PhoneService = row2.PhoneService ;
uniqueServices_tmp.MultipleLines = row2.MultipleLines ;
uniqueServices_tmp.InternetService = row2.InternetService ;
uniqueServices_tmp.InternetType = row2.InternetType ;
uniqueServices_tmp.OnlineSecurity = row2.OnlineSecurity ;
uniqueServices_tmp.OnlineBackup = row2.OnlineBackup ;
uniqueServices_tmp.DeviceProtectionPlan = row2.DeviceProtectionPlan ;
uniqueServices_tmp.PremiumTechSupport = row2.PremiumTechSupport ;
uniqueServices_tmp.StreamingTV = row2.StreamingTV ;
uniqueServices_tmp.StreamingMovies = row2.StreamingMovies ;
uniqueServices_tmp.StreamingMusic = row2.StreamingMusic ;
uniqueServices_tmp.UnlimitedData = row2.UnlimitedData ;
uniqueServices = uniqueServices_tmp;
// ###############################
 ...
 */
// Start of branch "uniqueServices"
if(uniqueServices != null) { 
	...
	currentComponent="tFileOutputDelimited_1";
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                            if(uniqueServices.ServiceID != null) {
                        sb_tFileOutputDelimited_1.append(
                            uniqueServices.ServiceID
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(uniqueServices.ServiceHash != null) {
                        sb_tFileOutputDelimited_1.append(
                            uniqueServices.ServiceHash
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(uniqueServices.PhoneService != null) {
                        sb_tFileOutputDelimited_1.append(
                            uniqueServices.PhoneService
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(uniqueServices.MultipleLines != null) {
                        sb_tFileOutputDelimited_1.append(
                            uniqueServices.MultipleLines
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(uniqueServices.InternetService != null) {
                        sb_tFileOutputDelimited_1.append(
                            uniqueServices.InternetService
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(uniqueServices.InternetType != null) {
                        sb_tFileOutputDelimited_1.append(
                            uniqueServices.InternetType
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(uniqueServices.OnlineSecurity != null) {
                        sb_tFileOutputDelimited_1.append(
                            uniqueServices.OnlineSecurity
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(uniqueServices.OnlineBackup != null) {
                        sb_tFileOutputDelimited_1.append(
                            uniqueServices.OnlineBackup
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(uniqueServices.DeviceProtectionPlan != null) {
                        sb_tFileOutputDelimited_1.append(
                            uniqueServices.DeviceProtectionPlan
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(uniqueServices.PremiumTechSupport != null) {
                        sb_tFileOutputDelimited_1.append(
                            uniqueServices.PremiumTechSupport
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(uniqueServices.StreamingTV != null) {
                        sb_tFileOutputDelimited_1.append(
                            uniqueServices.StreamingTV
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(uniqueServices.StreamingMovies != null) {
                        sb_tFileOutputDelimited_1.append(
                            uniqueServices.StreamingMovies
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(uniqueServices.StreamingMusic != null) {
                        sb_tFileOutputDelimited_1.append(
                            uniqueServices.StreamingMusic
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(uniqueServices.UnlimitedData != null) {
                        sb_tFileOutputDelimited_1.append(
                            uniqueServices.UnlimitedData
                        );
                            }
 ...
 */
	...
	currentComponent="tFileOutputDelimited_1";
		...
		resourceMap.put("finish_tFileOutputDelimited_1", true);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"uniqueServices");
			  	}
 ...
 */
	...
	System.err.println("Le fichier " +"CHURN_"+ TalendDate.getDate("YYYYMMDD") +" _SERVICE.csv" +"  existe déjà dans le repertoire du jour "+ context.dataFolder + TalendDate.getDate("YYYYMMDD") + "/" );
	
	globalMap.put("tDie_1_DIE_MESSAGE", "Le fichier " +"CHURN_"+ TalendDate.getDate("YYYYMMDD") +" _SERVICE.csv" +"  existe déjà dans le repertoire du jour "+ context.dataFolder + TalendDate.getDate("YYYYMMDD") + "/" );
	globalMap.put("tDie_1_DIE_MESSAGES", "Le fichier " +"CHURN_"+ TalendDate.getDate("YYYYMMDD") +" _SERVICE.csv" +"  existe déjà dans le repertoire du jour "+ context.dataFolder + TalendDate.getDate("YYYYMMDD") + "/" );
 ...
 */
    ...
    public static void main(String[] args){
        final jExtractServices jExtractServicesClass = new jExtractServices();

        int exitCode = jExtractServicesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jExtractServices.class.getClassLoader().getResourceAsStream("churn_project/jextractservices_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = jExtractServices.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jExtractServices");
        }
...
/************************************************************************************************
 *     177969 characters generated by Talend Open Studio for Data Integration 
 *     on the 31 décembre 2025 à 11:36:19 EET
 ************************************************************************************************/