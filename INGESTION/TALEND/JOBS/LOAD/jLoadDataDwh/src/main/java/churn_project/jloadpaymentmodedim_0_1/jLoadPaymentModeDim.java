...
package churn_project.jloadpaymentmodedim_0_1;
...
/**
 * Job: jLoadPaymentModeDim Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class jLoadPaymentModeDim implements TalendJob {
...
public String getProjectFolder(){
	...
	private final String jobName = "jLoadPaymentModeDim";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jLoadPaymentModeDim.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jLoadPaymentModeDim.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
globalMap.put("nomFichier", "CHURN_"+ TalendDate.getDate("YYYYMMDD") +"_PAYMENT_MODE.csv");
globalMap.put("nomFlux", "PAYMENT_MODE");
...
public static class insertOfferStruct implements routines.system.IPersistableRow<insertOfferStruct> {
    final static byte[] commonByteArrayLock_CHURN_PROJECT_jLoadPaymentModeDim = new byte[0];
    static byte[] commonByteArray_CHURN_PROJECT_jLoadPaymentModeDim = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final insertOfferStruct other = (insertOfferStruct) obj;
	...
	public void copyDataTo(insertOfferStruct other) {
	...
	public void copyKeysDataTo(insertOfferStruct other) {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_CHURN_PROJECT_jLoadPaymentModeDim.length) {
				if(length < 1024 && commonByteArray_CHURN_PROJECT_jLoadPaymentModeDim.length == 0) {
   					commonByteArray_CHURN_PROJECT_jLoadPaymentModeDim = new byte[1024];
				} else {
   					commonByteArray_CHURN_PROJECT_jLoadPaymentModeDim = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_CHURN_PROJECT_jLoadPaymentModeDim, 0, length);
			strReturn = new String(commonByteArray_CHURN_PROJECT_jLoadPaymentModeDim, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_CHURN_PROJECT_jLoadPaymentModeDim, 0, length);
			strReturn = new String(commonByteArray_CHURN_PROJECT_jLoadPaymentModeDim, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_CHURN_PROJECT_jLoadPaymentModeDim) {
     ...
     * Compare keys
     */
    public int compareTo(insertOfferStruct other) {
...
insertOfferStruct insertOffer = new insertOfferStruct();
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"insertOffer");
					}
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("DWH_DIM_PAYMENT");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("DWH_DIM_PAYMENT");
}
...
int count_tDBOutput_1=0;
	    java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_1 + "\" WHERE \"PAYMENT_ID\" = ?");
	    resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"PAYMENT_ID\",\"PAYMENT_METHOD\",\"LB_NOM_FICHIER\",\"DT_INSERTION\",\"LB_JOB_NAME\") VALUES (?,?,?,?,?)";
	    java.sql.PreparedStatement pstmtInsert_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(insert_tDBOutput_1);
	    resourceMap.put("pstmtInsert_tDBOutput_1", pstmtInsert_tDBOutput_1);
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"PAYMENT_METHOD\" = ?,\"LB_NOM_FICHIER\" = ?,\"DT_INSERTION\" = ?,\"LB_JOB_NAME\" = ? WHERE \"PAYMENT_ID\" = ?";
...
insertOfferStruct insertOffer_tmp = new insertOfferStruct();
// ###############################
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
								  ...
								  if(hasCasePrimitiveKeyWithNull_tMap_1 || !tHash_Lookup_row2.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.PAYMENT_ID = '" + row2HashKey.PAYMENT_ID + "'");
								} // G 071
...
// # Output reject table : 'insertOffer'
// # Filter conditions 
if( rejectedInnerJoin_tMap_1 ) {
insertOffer_tmp.PAYMENT_ID = row1.PaymentModeID ;
insertOffer_tmp.PAYMENT_METHOD = row1.PaymentMethod ;
insertOffer_tmp.LB_NOM_FICHIER = ((String)globalMap.get("nomFichier")) ;
insertOffer_tmp.DT_INSERTION = TalendDate.getCurrentDate() ;
insertOffer_tmp.LB_JOB_NAME = jobName;
insertOffer = insertOffer_tmp;
...
if(insertOffer != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    pstmt_tDBOutput_1.setInt(1, insertOffer.PAYMENT_ID);
            ...
            if(checkCount_tDBOutput_1 > 0) {
                        if(insertOffer.PAYMENT_METHOD == null) {
pstmtUpdate_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(1, insertOffer.PAYMENT_METHOD);
}

                        if(insertOffer.LB_NOM_FICHIER == null) {
pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(2, insertOffer.LB_NOM_FICHIER);
}

                        if(insertOffer.DT_INSERTION != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(3, new java.sql.Timestamp(insertOffer.DT_INSERTION.getTime()));
} else {
pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.TIMESTAMP);
}

                        if(insertOffer.LB_JOB_NAME == null) {
pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(4, insertOffer.LB_JOB_NAME);
}

                        pstmtUpdate_tDBOutput_1.setInt(5 + count_tDBOutput_1, insertOffer.PAYMENT_ID);
...
globalMap.put("tDBOutput_1_ERROR_MESSAGE",e.getMessage());
                    ...
                    whetherReject_tDBOutput_1 = true;
                        ...
                        pstmtInsert_tDBOutput_1.setInt(1, insertOffer.PAYMENT_ID);

                        if(insertOffer.PAYMENT_METHOD == null) {
pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(2, insertOffer.PAYMENT_METHOD);
}

                        if(insertOffer.LB_NOM_FICHIER == null) {
pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(3, insertOffer.LB_NOM_FICHIER);
}

                        if(insertOffer.DT_INSERTION != null) {
pstmtInsert_tDBOutput_1.setTimestamp(4, new java.sql.Timestamp(insertOffer.DT_INSERTION.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_1.setString(5, insertOffer.LB_JOB_NAME);
}
 ...
 */
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"insertOffer");
			  	}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row2";
		...
		int tos_count_tAdvancedHash_row2 = 0;
			   		...
			   		// linked node: tMap_1 - inputs:(row1,row2) outputs:(insertOffer)
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.password; 
            ...
            row2.PAYMENT_ID = rs_tDBInput_1.getInt(1);
        	...
        	row2.PAYMENT_METHOD = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row2.LB_NOM_FICHIER = null;
							} else {
	                         		
        	row2.LB_NOM_FICHIER = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row2.DT_INSERTION = null;
							} else {
										
			row2.DT_INSERTION = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 4);
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row2.LB_JOB_NAME = null;
							} else {
	                         		
        	row2.LB_JOB_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, false);
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row2";
				...
				row2_HashRow.PAYMENT_METHOD = row2.PAYMENT_METHOD;
 ...
 */
    ...
    public static void main(String[] args){
        final jLoadPaymentModeDim jLoadPaymentModeDimClass = new jLoadPaymentModeDim();

        int exitCode = jLoadPaymentModeDimClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jLoadPaymentModeDim.class.getClassLoader().getResourceAsStream("churn_project/jloadpaymentmodedim_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = jLoadPaymentModeDim.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jLoadPaymentModeDim");
        }
...
/************************************************************************************************
 *     144790 characters generated by Talend Open Studio for Data Integration 
