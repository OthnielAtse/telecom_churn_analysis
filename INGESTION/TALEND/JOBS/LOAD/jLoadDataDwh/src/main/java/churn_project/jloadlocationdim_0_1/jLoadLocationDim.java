...
package churn_project.jloadlocationdim_0_1;
...
/**
 * Job: jLoadLocationDim Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class jLoadLocationDim implements TalendJob {
...
public String getProjectFolder(){
	...
	private final String jobName = "jLoadLocationDim";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jLoadLocationDim.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jLoadLocationDim.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
globalMap.put("nomFichier", "CHURN_"+ TalendDate.getDate("YYYYMMDD") +"_LOCATION.csv");
globalMap.put("nomFlux", "LOCATION");
...
public static class insertLocationStruct implements routines.system.IPersistableRow<insertLocationStruct> {
    final static byte[] commonByteArrayLock_CHURN_PROJECT_jLoadLocationDim = new byte[0];
    static byte[] commonByteArray_CHURN_PROJECT_jLoadLocationDim = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final insertLocationStruct other = (insertLocationStruct) obj;
	...
	public void copyDataTo(insertLocationStruct other) {
	...
	public void copyKeysDataTo(insertLocationStruct other) {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_CHURN_PROJECT_jLoadLocationDim.length) {
				if(length < 1024 && commonByteArray_CHURN_PROJECT_jLoadLocationDim.length == 0) {
   					commonByteArray_CHURN_PROJECT_jLoadLocationDim = new byte[1024];
				} else {
   					commonByteArray_CHURN_PROJECT_jLoadLocationDim = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_CHURN_PROJECT_jLoadLocationDim, 0, length);
			strReturn = new String(commonByteArray_CHURN_PROJECT_jLoadLocationDim, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_CHURN_PROJECT_jLoadLocationDim, 0, length);
			strReturn = new String(commonByteArray_CHURN_PROJECT_jLoadLocationDim, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_CHURN_PROJECT_jLoadLocationDim) {
     ...
     * Compare keys
     */
    public int compareTo(insertLocationStruct other) {
...
insertLocationStruct insertLocation = new insertLocationStruct();
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"insertLocation");
					}
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("DWH_DIM_LOCATION");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("DWH_DIM_LOCATION");
}
...
int count_tDBOutput_1=0;
	    java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_1 + "\" WHERE \"LOCATION_ID\" = ?");
	    resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"LOCATION_ID\",\"CITY\",\"ZIP_CODE\",\"LATITUDE\",\"LONGITUDE\",\"LB_NOM_FICHIER\",\"DT_INSERTION\",\"LB_JOB_NAME\") VALUES (?,?,?,?,?,?,?,?)";
	    java.sql.PreparedStatement pstmtInsert_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(insert_tDBOutput_1);
	    resourceMap.put("pstmtInsert_tDBOutput_1", pstmtInsert_tDBOutput_1);
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"CITY\" = ?,\"ZIP_CODE\" = ?,\"LATITUDE\" = ?,\"LONGITUDE\" = ?,\"LB_NOM_FICHIER\" = ?,\"DT_INSERTION\" = ?,\"LB_JOB_NAME\" = ? WHERE \"LOCATION_ID\" = ?";
...
insertLocationStruct insertLocation_tmp = new insertLocationStruct();
// ###############################
					...
					columnIndexWithD_tFileInputDelimited_1 = 3;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row1.Lattitude = ParserUtils.parseTo_Float(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_1) {
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"Lattitude", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
 					    ...
 					    boolean forceLooprow2 = false;
 							...
 							row2Struct row2ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
	                        		    	...
	                        		    	Object exprKeyValue_row2__LOCATION_ID = row1.LocationID ;
	                        		    	if(exprKeyValue_row2__LOCATION_ID == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			row2HashKey.LOCATION_ID = (int)(Integer) exprKeyValue_row2__LOCATION_ID;
                        		    		}
								  ...
								  if(hasCasePrimitiveKeyWithNull_tMap_1 || !tHash_Lookup_row2.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.LOCATION_ID = '" + row2HashKey.LOCATION_ID + "'");
								} // G 071
...
// # Output reject table : 'insertLocation'
// # Filter conditions 
if( rejectedInnerJoin_tMap_1 ) {
insertLocation_tmp.LOCATION_ID = row1.LocationID ;
insertLocation_tmp.CITY = row1.City ;
insertLocation_tmp.ZIP_CODE = row1.ZipCode ;
insertLocation_tmp.LATITUDE = row1.Lattitude ;
insertLocation_tmp.LONGITUDE = row1.Longitude ;
insertLocation_tmp.LB_NOM_FICHIER = ((String)globalMap.get("nomFichier")) ;
insertLocation_tmp.DT_INSERTION = TalendDate.getCurrentDate() ;
insertLocation_tmp.LB_JOB_NAME = jobName;
insertLocation = insertLocation_tmp;
 ...
 */
// Start of branch "insertLocation"
if(insertLocation != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    pstmt_tDBOutput_1.setInt(1, insertLocation.LOCATION_ID);
            ...
            if(checkCount_tDBOutput_1 > 0) {
                        if(insertLocation.CITY == null) {
pstmtUpdate_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(1, insertLocation.CITY);
}

                        if(insertLocation.ZIP_CODE == null) {
pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(2, insertLocation.ZIP_CODE);
}

                        pstmtUpdate_tDBOutput_1.setDouble(3, insertLocation.LATITUDE);

                        pstmtUpdate_tDBOutput_1.setDouble(4, insertLocation.LONGITUDE);

                        if(insertLocation.LB_NOM_FICHIER == null) {
pstmtUpdate_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(5, insertLocation.LB_NOM_FICHIER);
}

                        if(insertLocation.DT_INSERTION != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(6, new java.sql.Timestamp(insertLocation.DT_INSERTION.getTime()));
} else {
pstmtUpdate_tDBOutput_1.setNull(6, java.sql.Types.TIMESTAMP);
}

                        if(insertLocation.LB_JOB_NAME == null) {
pstmtUpdate_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(7, insertLocation.LB_JOB_NAME);
}

                        pstmtUpdate_tDBOutput_1.setInt(8 + count_tDBOutput_1, insertLocation.LOCATION_ID);
...
globalMap.put("tDBOutput_1_ERROR_MESSAGE",e.getMessage());
                    ...
                    whetherReject_tDBOutput_1 = true;
                        ...
                        pstmtInsert_tDBOutput_1.setInt(1, insertLocation.LOCATION_ID);

                        if(insertLocation.CITY == null) {
pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(2, insertLocation.CITY);
}

                        if(insertLocation.ZIP_CODE == null) {
pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(3, insertLocation.ZIP_CODE);
}

                        pstmtInsert_tDBOutput_1.setDouble(4, insertLocation.LATITUDE);

                        pstmtInsert_tDBOutput_1.setDouble(5, insertLocation.LONGITUDE);

                        if(insertLocation.LB_NOM_FICHIER == null) {
pstmtInsert_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(6, insertLocation.LB_NOM_FICHIER);
}

                        if(insertLocation.DT_INSERTION != null) {
pstmtInsert_tDBOutput_1.setTimestamp(7, new java.sql.Timestamp(insertLocation.DT_INSERTION.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_1.setString(8, insertLocation.LB_JOB_NAME);
}
 ...
 */
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"insertLocation");
			  	}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row2";
		...
		int tos_count_tAdvancedHash_row2 = 0;
			   		...
			   		// linked node: tMap_1 - inputs:(row1,row2) outputs:(insertLocation)
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.password; 
            ...
            row2.LOCATION_ID = rs_tDBInput_1.getInt(1);
        	...
        	row2.CITY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row2.ZIP_CODE = null;
							} else {
	                         		
        	row2.ZIP_CODE = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row2.LATITUDE = 0;
							} else {
	                         		
            row2.LATITUDE = rs_tDBInput_1.getDouble(4);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row2.LONGITUDE = rs_tDBInput_1.getDouble(5);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row2.LB_NOM_FICHIER = routines.system.JDBCUtil.getString(rs_tDBInput_1, 6, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 7) {
								row2.DT_INSERTION = null;
							} else {
										
			row2.DT_INSERTION = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 7);
		                    }
							if(colQtyInRs_tDBInput_1 < 8) {
								row2.LB_JOB_NAME = null;
							} else {
	                         		
        	row2.LB_JOB_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_1, 8, false);
		                    }
 ...
 */
    ...
    public static void main(String[] args){
        final jLoadLocationDim jLoadLocationDimClass = new jLoadLocationDim();

        int exitCode = jLoadLocationDimClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jLoadLocationDim.class.getClassLoader().getResourceAsStream("churn_project/jloadlocationdim_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = jLoadLocationDim.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jLoadLocationDim");
        }
...
/************************************************************************************************
 *     155985 characters generated by Talend Open Studio for Data Integration 
