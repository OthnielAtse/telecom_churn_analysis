...
package churn_project.jextractoffer_0_1;
...
/**
 * Job: jExtractOffer Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class jExtractOffer implements TalendJob {
...
public String getProjectFolder(){
	...
	private final String jobName = "jExtractOffer";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jExtractOffer.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jExtractOffer.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
java.io.File file_tFileExist_1 = new java.io.File(context.dataFolder + TalendDate.getDate("YYYYMMDD") + "/" + "CHURN_"+ TalendDate.getDate("YYYYMMDD") +"_OFFER.csv");
...
globalMap.put("tFileExist_1_FILENAME",context.dataFolder + TalendDate.getDate("YYYYMMDD") + "/" + "CHURN_"+ TalendDate.getDate("YYYYMMDD") +"_OFFER.csv");
...
public static class uniqueChurnStruct implements routines.system.IPersistableRow<uniqueChurnStruct> {
    final static byte[] commonByteArrayLock_CHURN_PROJECT_jExtractOffer = new byte[0];
    static byte[] commonByteArray_CHURN_PROJECT_jExtractOffer = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_CHURN_PROJECT_jExtractOffer.length) {
				if(length < 1024 && commonByteArray_CHURN_PROJECT_jExtractOffer.length == 0) {
   					commonByteArray_CHURN_PROJECT_jExtractOffer = new byte[1024];
				} else {
   					commonByteArray_CHURN_PROJECT_jExtractOffer = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_CHURN_PROJECT_jExtractOffer, 0, length);
			strReturn = new String(commonByteArray_CHURN_PROJECT_jExtractOffer, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_CHURN_PROJECT_jExtractOffer, 0, length);
			strReturn = new String(commonByteArray_CHURN_PROJECT_jExtractOffer, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_CHURN_PROJECT_jExtractOffer) {
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File(context.dataFolder + TalendDate.getDate("YYYYMMDD") + "/" + "CHURN_"+ TalendDate.getDate("YYYYMMDD") +"_OFFER.csv")).getAbsolutePath().replace("\\","/");
...
customers_tmp.OfferID = null;
customers_tmp.Offer = StringHandling.TRIM(row1.Offer) ;
...
row2 = null;			
if(customers.Offer == null){
	finder_tUniqRow_1.Offer = null;
}else{
	finder_tUniqRow_1.Offer = customers.Offer.toLowerCase();
}	
...
if(customers.Offer == null){
	new_tUniqRow_1.Offer = null;
}else{
	new_tUniqRow_1.Offer = customers.Offer.toLowerCase();
}
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row2 == null){ 
	
	row2 = new row2Struct();
}row2.OfferID = customers.OfferID;			row2.Offer = customers.Offer;					
...
uniqueChurn_tmp.OfferID = Var.id ;
uniqueChurn_tmp.Offer = row2.Offer ;
...
if(uniqueChurn != null) { 
	...
	currentComponent="tFileOutputDelimited_1";
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                            if(uniqueChurn.OfferID != null) {
                        sb_tFileOutputDelimited_1.append(
                            uniqueChurn.OfferID
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(uniqueChurn.Offer != null) {
                        sb_tFileOutputDelimited_1.append(
                            uniqueChurn.Offer
                        );
                            }
 ...
 */
	...
	System.err.println("Le fichier " +"CHURN_"+ TalendDate.getDate("YYYYMMDD") +" _OFFER.csv" +"  existe déjà dans le repertoire du jour "+ context.dataFolder + TalendDate.getDate("YYYYMMDD") + "/" );
	
	globalMap.put("tDie_1_DIE_MESSAGE", "Le fichier " +"CHURN_"+ TalendDate.getDate("YYYYMMDD") +" _OFFER.csv" +"  existe déjà dans le repertoire du jour "+ context.dataFolder + TalendDate.getDate("YYYYMMDD") + "/" );
	globalMap.put("tDie_1_DIE_MESSAGES", "Le fichier " +"CHURN_"+ TalendDate.getDate("YYYYMMDD") +" _OFFER.csv" +"  existe déjà dans le repertoire du jour "+ context.dataFolder + TalendDate.getDate("YYYYMMDD") + "/" );
 ...
 */
    ...
    public static void main(String[] args){
        final jExtractOffer jExtractOfferClass = new jExtractOffer();

        int exitCode = jExtractOfferClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jExtractOffer.class.getClassLoader().getResourceAsStream("churn_project/jextractoffer_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = jExtractOffer.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jExtractOffer");
        }
...
/************************************************************************************************
 *     152819 characters generated by Talend Open Studio for Data Integration 
