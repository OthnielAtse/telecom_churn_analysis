...
package churn_project.jextractcustomer_0_1;
...
/**
 * Job: jExtractCustomer Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class jExtractCustomer implements TalendJob {
...
public String getProjectFolder(){
	...
	private final String jobName = "jExtractCustomer";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jExtractCustomer.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jExtractCustomer.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
java.io.File file_tFileExist_1 = new java.io.File(context.dataFolder + TalendDate.getDate("YYYYMMDD") + "/" + "CHURN_"+ TalendDate.getDate("YYYYMMDD") +"_CUSTOMER.csv");
...
globalMap.put("tFileExist_1_FILENAME",context.dataFolder + TalendDate.getDate("YYYYMMDD") + "/" + "CHURN_"+ TalendDate.getDate("YYYYMMDD") +"_CUSTOMER.csv");
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_CHURN_PROJECT_jExtractCustomer = new byte[0];
    static byte[] commonByteArray_CHURN_PROJECT_jExtractCustomer = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_CHURN_PROJECT_jExtractCustomer.length) {
				if(length < 1024 && commonByteArray_CHURN_PROJECT_jExtractCustomer.length == 0) {
   					commonByteArray_CHURN_PROJECT_jExtractCustomer = new byte[1024];
				} else {
   					commonByteArray_CHURN_PROJECT_jExtractCustomer = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_CHURN_PROJECT_jExtractCustomer, 0, length);
			strReturn = new String(commonByteArray_CHURN_PROJECT_jExtractCustomer, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_CHURN_PROJECT_jExtractCustomer, 0, length);
			strReturn = new String(commonByteArray_CHURN_PROJECT_jExtractCustomer, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_CHURN_PROJECT_jExtractCustomer) {
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File(context.dataFolder + TalendDate.getDate("YYYYMMDD") + "/" + "CHURN_"+ TalendDate.getDate("YYYYMMDD") +"_CUSTOMER.csv")).getAbsolutePath().replace("\\","/");
                    ...
                    if(directory_tFileOutputDelimited_1 != null && directory_tFileOutputDelimited_1.trim().length() != 0) {
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_1, false),"ISO-8859-15"));
                                    if(filetFileOutputDelimited_1.length()==0){
                                        ...
                                        outtFileOutputDelimited_1.write("LocationID");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
 					    ...
 					    boolean forceLooprow3 = false;
 							...
 							row3Struct row3ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row3HashKey.City = row1.City ;
                        		    		
                        		    		    row3HashKey.ZipCode = row1.ZipCode ;
								  ...
								  if(!tHash_Lookup_row3.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row3 != null && tHash_Lookup_row3.getCount(row3HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row3' and it contains more one result from keys :  row3.City = '" + row3HashKey.City + "', row3.ZipCode = '" + row3HashKey.ZipCode + "'");
								} // G 071
...
customers_tmp.CustomerID = StringHandling.TRIM(row1.CustomerID) ;
customers_tmp.LocationID = row3.LocationID ;
customers_tmp.Gender = StringHandling.TRIM(row1.Gender) ;
customers_tmp.Age = row1.Age ;
customers_tmp.Married = StringHandling.TRIM(row1.Married) ;
customers_tmp.NumberOfDependents = row1.NumberOfDependents ;
customers_tmp.NumberOfReferrals = row1.NumberOfReferrals ;
...
if(customers.CustomerID == null){
	...
	finder_tUniqRow_1.CustomerID = customers.CustomerID.toLowerCase();
}	
...
if(customers.CustomerID == null){
	...
	new_tUniqRow_1.CustomerID = customers.CustomerID.toLowerCase();
}
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row2 == null){ 
	
	row2 = new row2Struct();
}row2.CustomerID = customers.CustomerID;			row2.LocationID = customers.LocationID;			row2.Gender = customers.Gender;			row2.Age = customers.Age;			row2.Married = customers.Married;			row2.NumberOfDependents = customers.NumberOfDependents;			row2.NumberOfReferrals = customers.NumberOfReferrals;					
	...
	currentComponent="tFileOutputDelimited_1";
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_1.append(
                            ...
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row2.Married != null) {
                        sb_tFileOutputDelimited_1.append(
                            row2.Married
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row2.NumberOfDependents != null) {
                        sb_tFileOutputDelimited_1.append(
                            row2.NumberOfDependents
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row2.NumberOfReferrals != null) {
                        sb_tFileOutputDelimited_1.append(
                            row2.NumberOfReferrals
                        );
                            }
 ...
 */
	...
	System.err.println("Le fichier " +"CHURN_"+ TalendDate.getDate("YYYYMMDD") +" _CUSTOMER.csv" +"  existe déjà dans le repertoire du jour " + context.dataFolder + TalendDate.getDate("YYYYMMDD") + "/" );
	
	globalMap.put("tDie_1_DIE_MESSAGE", "Le fichier " +"CHURN_"+ TalendDate.getDate("YYYYMMDD") +" _CUSTOMER.csv" +"  existe déjà dans le repertoire du jour " + context.dataFolder + TalendDate.getDate("YYYYMMDD") + "/" );
	globalMap.put("tDie_1_DIE_MESSAGES", "Le fichier " +"CHURN_"+ TalendDate.getDate("YYYYMMDD") +" _CUSTOMER.csv" +"  existe déjà dans le repertoire du jour " + context.dataFolder + TalendDate.getDate("YYYYMMDD") + "/" );
...
public static class row3Struct implements routines.system.IPersistableComparableLookupRow<row3Struct> {
			...
			int length = 0;
			            ...
			            length = objectIn.readByte();
           				if (length == -1) {
           			    	...
           			    	this.Lattitude = objectIn.readFloat();
           				}
			            ...
			            length = objectIn.readByte();
           				if (length == -1) {
           			    	...
           			    	this.Longitude = objectIn.readFloat();
           				}
                ...
                try {
					...
					writeInteger(this.LocationID, dos, objectOut);
						...
						if(this.Lattitude == null) {
							...
							objectOut.writeFloat(this.Lattitude);
		            	}
						...
						if(this.Longitude == null) {
							...
							objectOut.writeByte(0);
							objectOut.writeFloat(this.Longitude);
		            	}
    ...
    public int compareTo(row3Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.ZipCode, other.ZipCode);
						if(returnValue != 0) {
							return returnValue;
						}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row3";
		...
		int tos_count_tAdvancedHash_row3 = 0;
			   		...
			   		// source node:tFileInputDelimited_2 - inputs:(after_tFileInputDelimited_1) outputs:(row3,row3) | target node:tAdvancedHash_row3 - inputs:(row3) outputs:()
			   		// linked node: tMap_1 - inputs:(row1,row3) outputs:(customers)
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_2 = context.dataFolder + TalendDate.getDate("YYYYMMDD") + "/" + "CHURN_"+ TalendDate.getDate("YYYYMMDD") +"_LOCATION.csv";
			...
			if(footer_value_tFileInputDelimited_2 >0 || random_value_tFileInputDelimited_2 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_2 = new org.talend.fileprocess.FileInputDelimited(context.dataFolder + TalendDate.getDate("YYYYMMDD") + "/" + "CHURN_"+ TalendDate.getDate("YYYYMMDD") +"_LOCATION.csv", context.encodage,context.fileSeparator,"\n",true,1,0,
					...
					columnIndexWithD_tFileInputDelimited_2 = 0;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row3.LocationID = ParserUtils.parseTo_Integer(temp);
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"LocationID", "row3", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
					...
					columnIndexWithD_tFileInputDelimited_2 = 2;
							...
							row3.ZipCode = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
					...
					columnIndexWithD_tFileInputDelimited_2 = 3;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row3.Lattitude = ParserUtils.parseTo_Float(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_2) {
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"Lattitude", "row3", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
					...
					columnIndexWithD_tFileInputDelimited_2 = 4;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row3.Longitude = ParserUtils.parseTo_Float(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_2) {
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"Longitude", "row3", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
...
if(row3 != null) { 
	...
	currentComponent="tAdvancedHash_row3";
				...
				row3_HashRow.ZipCode = row3.ZipCode;
				
				row3_HashRow.Lattitude = row3.Lattitude;
 ...
 */
	...
	currentComponent="tFileInputDelimited_2";
                ...
                if(!((Object)(context.dataFolder + TalendDate.getDate("YYYYMMDD") + "/" + "CHURN_"+ TalendDate.getDate("YYYYMMDD") +"_LOCATION.csv") instanceof java.io.InputStream)){
 ...
 */
    ...
    public static void main(String[] args){
        final jExtractCustomer jExtractCustomerClass = new jExtractCustomer();

        int exitCode = jExtractCustomerClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jExtractCustomer.class.getClassLoader().getResourceAsStream("churn_project/jextractcustomer_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = jExtractCustomer.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jExtractCustomer");
        }
...
/************************************************************************************************
 *     207190 characters generated by Talend Open Studio for Data Integration 
