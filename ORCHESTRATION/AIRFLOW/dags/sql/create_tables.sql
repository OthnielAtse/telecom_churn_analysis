...
-- Définir le schéma à utiliser
SET SEARCH_PATH = "CHURN_DWH";


----------------------------------------------------------------------------
--------------- Table N°2 : "CHURN_CUSTOMER_DWH"."DWH_DIM_LOCATION" -------------
----------------------------------------------------------------------------
-- DROP TABLE IF EXISTS "DWH_DIM_LOCATION" CASCADE;
CREATE TABLE IF NOT EXISTS "DWH_DIM_LOCATION" (
...
----------------------------------------------------------------------------
-- DROP TABLE IF EXISTS "DWH_DIM_CUSTOMER" CASCADE;
CREATE TABLE IF NOT EXISTS "DWH_DIM_CUSTOMER" (
...
----------------------------------------------------------------------------
-- DROP TABLE IF EXISTS "DWH_DIM_CONTRACT" CASCADE;
CREATE TABLE IF NOT EXISTS "DWH_DIM_CONTRACT" (
...
----------------------------------------------------------------------------
-- DROP TABLE IF EXISTS "DWH_DIM_PAYMENT" CASCADE;
CREATE TABLE IF NOT EXISTS "DWH_DIM_PAYMENT" (
...
----------------------------------------------------------------------------
-- DROP TABLE IF EXISTS "DWH_DIM_OFFER" CASCADE;
CREATE TABLE IF NOT EXISTS "DWH_DIM_OFFER" (
...
----------------------------------------------------------------------------
-- DROP TABLE IF EXISTS "DWH_DIM_CHURN" CASCADE;
CREATE TABLE IF NOT EXISTS "DWH_DIM_CHURN" (
...
----------------------------------------------------------------------------
-- DROP TABLE IF EXISTS "DWH_DIM_SERVICE" CASCADE;
CREATE TABLE IF NOT EXISTS "DWH_DIM_SERVICE" (
...
----------------------------------------------------------------------------
-- DROP TABLE IF EXISTS "FACT_CUSTOMER_CHURN" CASCADE;
...
----------------------------------------------------------------------------
-- DROP TABLE IF EXISTS "DWH_REJET" CASCADE;
CREATE TABLE IF NOT EXISTS "DWH_REJET" 
(
