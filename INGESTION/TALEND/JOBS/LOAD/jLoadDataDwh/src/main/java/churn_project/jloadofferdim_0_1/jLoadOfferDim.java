...
package churn_project.jloadofferdim_0_1;
...
/**
 * Job: jLoadOfferDim Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class jLoadOfferDim implements TalendJob {
...
public String getProjectFolder(){
	...
	private final String jobName = "jLoadOfferDim";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jLoadOfferDim.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jLoadOfferDim.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
globalMap.put("nomFichier", "CHURN_"+ TalendDate.getDate("YYYYMMDD") +"_OFFER.csv");
globalMap.put("nomFlux", "OFFER");
...
public static class insertOfferStruct implements routines.system.IPersistableRow<insertOfferStruct> {
    final static byte[] commonByteArrayLock_CHURN_PROJECT_jLoadOfferDim = new byte[0];
    static byte[] commonByteArray_CHURN_PROJECT_jLoadOfferDim = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_CHURN_PROJECT_jLoadOfferDim.length) {
				if(length < 1024 && commonByteArray_CHURN_PROJECT_jLoadOfferDim.length == 0) {
   					commonByteArray_CHURN_PROJECT_jLoadOfferDim = new byte[1024];
				} else {
   					commonByteArray_CHURN_PROJECT_jLoadOfferDim = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_CHURN_PROJECT_jLoadOfferDim, 0, length);
			strReturn = new String(commonByteArray_CHURN_PROJECT_jLoadOfferDim, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_CHURN_PROJECT_jLoadOfferDim, 0, length);
			strReturn = new String(commonByteArray_CHURN_PROJECT_jLoadOfferDim, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_CHURN_PROJECT_jLoadOfferDim) {
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("DWH_DIM_OFFER");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("DWH_DIM_OFFER");
}
...
int count_tDBOutput_1=0;
	    java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_1 + "\" WHERE \"OFFER_ID\" = ?");
	    resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"OFFER_ID\",\"OFFER\",\"LB_NOM_FICHIER\",\"DT_INSERTION\",\"LB_JOB_NAME\") VALUES (?,?,?,?,?)";
	    java.sql.PreparedStatement pstmtInsert_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(insert_tDBOutput_1);
	    resourceMap.put("pstmtInsert_tDBOutput_1", pstmtInsert_tDBOutput_1);
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"OFFER\" = ?,\"LB_NOM_FICHIER\" = ?,\"DT_INSERTION\" = ?,\"LB_JOB_NAME\" = ? WHERE \"OFFER_ID\" = ?";
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
					...
					columnIndexWithD_tFileInputDelimited_1 = 1;
							...
							row1.Offer = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
								  ...
								  if(hasCasePrimitiveKeyWithNull_tMap_1 || !tHash_Lookup_row2.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.OFFER_ID = '" + row2HashKey.OFFER_ID + "'");
								} // G 071
...
// # Filter conditions 
if( rejectedInnerJoin_tMap_1 ) {
insertOffer_tmp.OFFER_ID = row1.OfferID ;
insertOffer_tmp.OFFER = row1.Offer ;
...
if(insertOffer != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    pstmt_tDBOutput_1.setInt(1, insertOffer.OFFER_ID);
            ...
            if(checkCount_tDBOutput_1 > 0) {
                        if(insertOffer.OFFER == null) {
pstmtUpdate_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(1, insertOffer.OFFER);
}
...
pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
                        ...
                        pstmtUpdate_tDBOutput_1.setInt(5 + count_tDBOutput_1, insertOffer.OFFER_ID);
...
globalMap.put("tDBOutput_1_ERROR_MESSAGE",e.getMessage());
                    ...
                    whetherReject_tDBOutput_1 = true;
                        ...
                        pstmtInsert_tDBOutput_1.setInt(1, insertOffer.OFFER_ID);

                        if(insertOffer.OFFER == null) {
pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(2, insertOffer.OFFER);
}
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.password; 
            ...
            row2.OFFER_ID = rs_tDBInput_1.getInt(1);
        	...
        	row2.OFFER = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
 ...
 */
    ...
    public static void main(String[] args){
        final jLoadOfferDim jLoadOfferDimClass = new jLoadOfferDim();

        int exitCode = jLoadOfferDimClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jLoadOfferDim.class.getClassLoader().getResourceAsStream("churn_project/jloadofferdim_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = jLoadOfferDim.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jLoadOfferDim");
        }
...
/************************************************************************************************
 *     143652 characters generated by Talend Open Studio for Data Integration 
